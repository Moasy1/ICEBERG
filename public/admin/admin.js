...
function renderAdminAudits(audits) {
    ...
    audits.forEach((item, index) => {
        ...
        let adminRowLinks = '';
        if (item.website) adminRowLinks += `<a href="${item.website}" target="_blank" rel="noopener noreferrer" title="Website: ${item.website}" class="px-1.5 py-0.5 bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 rounded text-[10px] font-bold hover:bg-cyan-500/40 transition-all inline-flex items-center gap-1"><img src="/admin/globe-language-svgrepo-com.svg" class="w-3 h-3 brightness-0 invert" alt="Web"> Web</a> `;
        if (item.social_links) {
            if (item.social_links.facebook) adminRowLinks += `<a href="${item.social_links.facebook}" target="_blank" rel="noopener noreferrer" title="Facebook" class="px-1.5 py-0.5 bg-blue-500/20 text-blue-300 border border-blue-500/30 rounded text-[10px] font-bold hover:bg-blue-500/40 transition-all inline-flex items-center gap-1"><img src="/admin/facebook-svgrepo-com.svg" class="w-3 h-3 brightness-0 invert" alt="FB"> FB</a> `;
            if (item.social_links.instagram) adminRowLinks += `<a href="${item.social_links.instagram}" target="_blank" rel="noopener noreferrer" title="Instagram" class="px-1.5 py-0.5 bg-pink-500/20 text-pink-300 border border-pink-500/30 rounded text-[10px] font-bold hover:bg-pink-500/40 transition-all inline-flex items-center gap-1"><img src="/admin/instagram-logo-facebook-2-svgrepo-com.svg" class="w-3 h-3 brightness-0 invert" alt="IG"> IG</a> `;
            if (item.social_links.linkedin) adminRowLinks += `<a href="${item.social_links.linkedin}" target="_blank" rel="noopener noreferrer" title="LinkedIn" class="px-1.5 py-0.5 bg-emerald-500/20 text-emerald-300 border border-emerald-500/30 rounded text-[10px] font-bold hover:bg-emerald-500/40 transition-all inline-flex items-center gap-1"><img src="/admin/linkedin-svgrepo-com.svg" class="w-3 h-3 brightness-0 invert" alt="LI"> LI</a> `;
            if (item.social_links.youtube) adminRowLinks += `<a href="${item.social_links.youtube}" target="_blank" rel="noopener noreferrer" title="YouTube" class="px-1.5 py-0.5 bg-red-500/20 text-red-300 border border-red-500/30 rounded text-[10px] font-bold hover:bg-red-500/40 transition-all inline-flex items-center gap-1"><img src="/admin/youtube-svgrepo-com.svg" class="w-3 h-3 brightness-0 invert" alt="YT"> YT</a>`;
        }
...
function viewAuditDetailsByName(name) {
    ...
    if (adminLinksEl && (audit.website || audit.social_links)) {
        let lhtml = '';
        if (audit.website) {
            lhtml += `<a href="${audit.website}" target="_blank" rel="noopener noreferrer" class="px-2.5 py-1 bg-cyan-500/20 hover:bg-cyan-500/30 text-cyan-400 border border-cyan-500/40 rounded text-xs font-semibold flex items-center gap-1.5 transition-all"><img src="/admin/globe-language-svgrepo-com.svg" class="w-3.5 h-3.5 brightness-0 invert" alt="Website"> Website</a>`;
        }
        if (audit.social_links) {
            if (audit.social_links.facebook) {
                lhtml += `<a href="${audit.social_links.facebook}" target="_blank" rel="noopener noreferrer" class="px-2.5 py-1 bg-blue-500/20 hover:bg-blue-500/30 text-blue-400 border border-blue-500/40 rounded text-xs font-semibold flex items-center gap-1.5 transition-all"><img src="/admin/facebook-svgrepo-com.svg" class="w-3.5 h-3.5 brightness-0 invert" alt="Facebook"> Facebook</a>`;
            }
            if (audit.social_links.instagram) {
                lhtml += `<a href="${audit.social_links.instagram}" target="_blank" rel="noopener noreferrer" class="px-2.5 py-1 bg-pink-500/20 hover:bg-pink-500/30 text-pink-400 border border-pink-500/40 rounded text-xs font-semibold flex items-center gap-1.5 transition-all"><img src="/admin/instagram-logo-facebook-2-svgrepo-com.svg" class="w-3.5 h-3.5 brightness-0 invert" alt="Instagram"> Instagram</a>`;
            }
            if (audit.social_links.linkedin) {
                lhtml += `<a href="${audit.social_links.linkedin}" target="_blank" rel="noopener noreferrer" class="px-2.5 py-1 bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-400 border border-emerald-500/40 rounded text-xs font-semibold flex items-center gap-1.5 transition-all"><img src="/admin/linkedin-svgrepo-com.svg" class="w-3.5 h-3.5 brightness-0 invert" alt="LinkedIn"> LinkedIn</a>`;
            }
            if (audit.social_links.youtube) {
                lhtml += `<a href="${audit.social_links.youtube}" target="_blank" rel="noopener noreferrer" class="px-2.5 py-1 bg-red-500/20 hover:bg-red-500/30 text-red-400 border border-red-500/40 rounded text-xs font-semibold flex items-center gap-1.5 transition-all"><img src="/admin/youtube-svgrepo-com.svg" class="w-3.5 h-3.5 brightness-0 invert" alt="YouTube"> YouTube</a>`;
            }
        }
