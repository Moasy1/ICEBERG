...
const UserSchema = new mongoose.Schema({
  ...
  role: {
    ...
    enum: [
      ...
      // Specialist Departmental Roles
      'DEVELOPER', 'DESIGNER', 'MEDIA_BUYER', 'VIDEO_EDITOR', 'COPYWRITER',
      'PROJECT_MANAGER', 'EXECUTIVE_SECRETARY', 'SALES_AGENT', 'QA_ENGINEER'
    ],
  ...
  okrs: [{
    ...
    category: {
      type: String,
      enum: ['DELIVERY', 'GROWTH', 'QUALITY', 'LEADERSHIP', 'INNOVATION', 'Output', 'Quality', 'Speed', 'Learning', 'Revenue'],
      default: 'DELIVERY'
    },
    key_results: [{
