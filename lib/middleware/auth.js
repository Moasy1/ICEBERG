...
const verifyToken = (req, res, next) => {
  // Allow executive bypass if header specifies demo admin or demo token is provided
  if (req.headers['x-demo-admin'] === 'true' || req.headers['authorization'] === 'Bearer demo_token' || req.headers['x-access-token'] === 'demo_token') {
    req.user = {
